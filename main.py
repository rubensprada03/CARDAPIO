...
def Total():
    ...
    string_bill="R$.",str('%.2f'%totalcost)
    Total_bill.set(string_bill)




Label(text="RUBENS MANAGMENT",bg="black",fg="white",font=("Gabriola",33), width="300",height="2").pack()

# MENU CARD
f=Frame(root,bg="lightgreen",highlightbackground="black",highlightthickness=5,width=300,height=370)
f.place(x=10,y=118) 



Label(f,text="Menu",font=("Gabriola", 40,'bold'),fg="black",bg="lightgreen").place(x=8,y=0)

Label(f,font=("Lucida Calligraphy",15,"bold"), text="Dosa.......R$60/plate",fg="black",bg="lightgreen").place(x=10,y=80)
Label(f,font=("Lucida Calligraphy",15,"bold"), text="Cookies.......R$30/plate",fg="black",bg="lightgreen").place(x=10,y=110)
Label(f,font=("Lucida Calligraphy",15,"bold"), text="Tea.......R$7/cup",fg="black",bg="lightgreen").place(x=10,y=140)
Label(f,font=("Lucida Calligraphy",15,"bold"), text="Coffee.......R$100/cup",fg="black",bg="lightgreen").place(x=10,y=170)
Label(f,font=("Lucida Calligraphy",15,"bold"), text="Juice.......R$20/glass",fg="black",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucida Calligraphy",15,"bold"), text="Pancake.......R$15/pack",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,"bold"), text="Eggs.......R$7/egg",fg="black",bg="lightgreen").place(x=10,y=260)
...
lbl_cookie=Label(f1,font=("arial",20,'bold'),text="Cookies",width=12,fg="blue4")
...
lbl_pancakes=Label(f1,font=("arial",20,'bold'),text="Pancake",width=12,fg="blue4")
lbl_eggs=Label(f1,font=("arial",20,'bold'),text="Eggs",width=12,fg="blue4")

lbl_dosa.grid(row=1,column=0)
lbl_cookie.grid(row=2,column=0)
...
entry_cookie=Entry(f1,font=("aria",20,'bold'),textvariable=cookies,bd=6,width=8,bg="lightpink")
